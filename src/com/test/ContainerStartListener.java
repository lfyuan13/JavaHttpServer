...
public class ContainerStartListener implements LifecycleListener{

	@Override
	public void lifecycleEvent(LifecycleEvent event) {
		if(event.getType() == Lifecycle.START_EVENT){
			LoggerUtil.getLogger(this.getClass().getPackage().toString()).log("Listener: container start event is started.", Logger.INFO);
		}
	}
